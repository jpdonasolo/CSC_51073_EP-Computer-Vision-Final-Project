...
### Kagglehub
The project also downloads datasets from [Kaggle](https://www.kaggle.com/) using `kagglehub`. In order to work properly, your machine must have an autentication API token. You and read [here](https://www.kaggle.com/docs/api).
